          ...
          <Grid item xs={12} sm={4}>
            ...
            <Box sx={{ display: 'flex', gap: 3, flexWrap: 'wrap' }}>
              <Typography variant="body2" sx={{ lineHeight: 1.6 }}>
                <a href="/chome" style={{ color: '#333', textDecoration: 'none' }}>Home</a>
              </Typography>
              <Typography variant="body2" sx={{ lineHeight: 1.6 }}>
                <a href="/products" style={{ color: '#333', textDecoration: 'none' }}>Products</a>
              </Typography>
              <Typography variant="body2" sx={{ lineHeight: 1.6 }}>
                <a href="/orders" style={{ color: '#333', textDecoration: 'none' }}>Orders</a>
              </Typography>
              <Typography variant="body2" sx={{ lineHeight: 1.6 }}>
                <a href="/customeradminfeedback" style={{ color: '#333', textDecoration: 'none' }}>Feedback</a>
              </Typography>
            </Box>
          </Grid>
